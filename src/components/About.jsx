...
function About() {
  return (
    <section id="sobre" className="section-shell">
      <div className="mx-auto grid max-w-6xl gap-10 px-5 py-16 md:px-6 md:py-24 lg:grid-cols-[0.72fr_1.28fr] lg:items-center">
        <motion.div
        ...
        >
          <div className="relative w-28 md:w-full">
            ...
            <div className="relative overflow-hidden rounded-full border border-white/10 bg-photo-panel shadow-[0_0_38px_rgba(16,212,208,0.08)]">
              <img
                src={profileImg}
